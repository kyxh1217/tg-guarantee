...
public class FreemarkerPdfUtils {
    private final static String RESOURCE_PATH = Objects.requireNonNull(FreemarkerPdfUtils.class.getResource("/static")).getPath();
    ...
    private static String compileTemplate(String templateFile, Map<String, Object> args) throws Exception {
        ...
        try {
            ...
            freemarkerCfg.setTemplateLoader(new ClassTemplateLoader(FreemarkerPdfUtils.class, "/templates/"));
