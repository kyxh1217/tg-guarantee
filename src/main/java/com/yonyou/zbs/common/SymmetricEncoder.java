...
public class SymmetricEncoder {
    ...
    public static void main(String[] args) {
        ...
        String enstr = SymmetricEncoder.AESEncode(encodeRules, content);
        System.out.println("encodeRules=" + encodeRules + "加密后的密文是:" + enstr);

        System.out.println("encodeRules=" + encodeRules + "解密后的明文是:" + SymmetricEncoder.AESDecode(encodeRules, enstr));
    }
